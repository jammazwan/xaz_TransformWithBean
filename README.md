...
Functionality: **_Transform a body using a bean_**
...
Git clone the xaz_TransformWithBean project into your workspace:

_from your bash shell:_

```bash
cd yourworkspacedirectory
git clone https://github.com/jammazwan/xaz_TransformWithBean.git
cd xaz_TransformWithBean
mvn install -DskipTests

```

You man now import xaz_TransformWithBean into your IDE.
...
_Run XazTest and observe new sorted version of the test file in the root of your project_
